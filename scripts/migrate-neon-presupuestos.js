...
// Crear una instancia de Prisma Client que use la base de datos de Neon
...
async function migrateNeonPresupuestos() {
  try {
    console.log('🔄 Iniciando migración de presupuestos desde Neon...\n');
