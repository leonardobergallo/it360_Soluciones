...
async function testPaginaPagoDirecto() {
  console.log('🧪 Probando página de pago directamente...\n');
  ...
  try {
    ...
    console.log('   • CBU: 0720156788000001781072');
    console.log('   • Alias: IT360.SOLUCIONES');
    console.log(`   • Link: http://localhost:3001/pagar/${ticket.ticketNumber}`);
    ...
    console.log('\n💡 Si el servidor no responde, reinícialo con Ctrl+C y luego npm run dev');
